        ...
        <div class="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              <h1 className="text-white text-xl">SalesCaptain</h1>
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
              <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-gray-900 text-white">
                  Products
                </p>
              ...
              <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-white ">Industry</p>

                <ul class="mt-8 space-y-4 text-sm">
                  <li>
                    <a
                      class="text-white  transition hover:text-gray-700/75"
                      href="https://salescaptain.com/#"
                    >
                      Healthcare
                    </a>
                  </li>
              ...
              <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-white">Partner</p>
                ...
                <ul class="mt-8 space-y-4 text-sm">
                  ...
                  <li>
                    <a
                      ...
                      href="/"
                    >
                      <span class="text-white transition group-hover:text-gray-700/75">
                        Legal
                      </span>
              ...
              <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-gray-500">US Headquarters</p>
                ...
                <ul class="mt-8 space-y-4 text-sm">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span class="flex-1 text-gray-500">India Office</span>
                      <span class="flex-1 text-white">
                  ...
                  <li class="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                    ...
                    <address class="-mt-0.5 flex-1 not-italic text-white">
                      213 Lane, London, United Kingdom 79 - 81 Borough Rd London
                      England 400706
                    </address>
                  </li>
                </ul>
